...
const Results = () => {
  ...
  const doSomething = async() =>{
    ...
    await axios.get(`${import.meta.env.VITE_BASE_URL}candidate/votecount`)
   .then(function (response) {
    ...
    response.data.map((d,ind)=>{
      data['labels'].push(d.party);
      data['datasets'][0]['data'].push(d.count)
      data['datasets'][0]['backgroundColor'].push(bg[ind])
    })

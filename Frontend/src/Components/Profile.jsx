...
const Profile = () => {
  const {userInfo,token,signOut}=useContext(AuthContext)
  ...
  const handleChangePass =async()=>{
    ...
    console.log(getValues("npassword"))
   
    await axios
      .put(`${import.meta.env.VITE_BASE_URL}user/profile/password`, {
        ...
        <div className="p-8 bg-white shadow mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3">
            ...
            <div className="space-x-8 flex justify-between mt-32 md:mt-0 md:justify-center">
              ...
              <button onClick={signOuthandler} className="text-white py-2 px-4 uppercase rounded bg-gray-700 hover:bg-gray-800 shadow hover:shadow-lg font-medium transition transform hover:-translate-y-0.5">
                {" "}
                Sign Out
              </button>{" "}
            </div>
          ...
          <div className="mt-20 text-center border-b pb-12">
            ...
            <p className="font-light text-gray-600 mt-3"> {userInfo.address} </p>
